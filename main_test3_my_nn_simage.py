...
def start_app(frame_width=640, frame_height=480, path_to_image='test_images/face_front.png'):

    try:
        get_face_params(frame_width, frame_height, path_to_image)
...
@torch.no_grad()
def get_face_params(frame_width=640, frame_height=480, path_to_image='test_images/face_front.png'):
...
start_app(frame_width=640, frame_height=480, path_to_image='test_images/face_top.png')
